...
C     ==================================================================
      ...
      iprintctl(6) = .true. ! User-provided subs calls counters and timing
      iprintctl(7) = .true. ! Statistic files with table lines
...
C     ==================================================================
      ...
      if ( iprintctl(6) ) then
          ...
          write(*,9010) fcoded,efcnt,gcoded,egcnt,hcoded,ehcnt,ccoded,
