...
C
C     The regular formulation of this problem would be
C
C     || pi ||^2 = 1, for all i, and dist(pi,pj)^2 >= 1, for all i < j.
C
C     In this formulation, using that
C
C     dist(pi,pj)^2 = || pi ||^2 + || pj ||^2 - 2 < pi,pj >
C
C     equations are
C
C     || pi ||^2 = 1, for all i, and < pi,pj > <= 0.5, for all i < j.
